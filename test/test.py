...
class OptionTest(unittest.TestCase):
    ...
    def test_add_primitive_actions(self):
        ...
        self.assertEqual(option_1.q.q_dict,
                         {Point(0, 0): {cardinal[0]: 0, cardinal[1]: 0, cardinal[2]: 0, cardinal[3]: 0}})
...
class QTests(unittest.TestCase):
    ...
    def test_update_q_dict(self):
        ...
        q_predict = {state: {
            action: (1 - LEARNING_RATE) * LEARNING_RATE * reward + LEARNING_RATE * (reward + state_action_value)},
                     new_state: {new_state: state_action_value}}
